...
#        name='param-discuss'),
    ...
    url(r'^hmf_finder/hmf_image_page/plots.zip$',
        ...
        name='all-plots'),
    url(r'^hmf_finder/hmf_image_page/mass_function.dat$',
        'HMFcalc.views.hmf_txt',
        name='hmf-txt'),
    url(r'^hmf_finder/hmf_image_page/units.dat$',
        'HMFcalc.views.units_txt',
        name='units-txt'),
    url(r'^hmf_finder/hmf_image_page/parameters.dat$',
        'HMFcalc.views.header_txt',
        name='header-txt'),
    url(r'^hmf_finder/hmf_image_page/power_spectrum.dat$',
        'HMFcalc.views.power_txt',
        name='power-txt'),
    url(r'^contact_info/$',
    ...
    url(r'^contact_info/emailme/$',
        ...
        name='contact-email'),
    url(r'^downloads/fitting_functions.pdf$',
        'HMFcalc.views.fitting_functions_pdf',
        name='fitting-function-pdf'),
    url(r'^email-sent/$',
